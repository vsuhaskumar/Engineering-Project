...
<body>
<div id="content">
	<form action="<%=request.getContextPath()%>/DeleteBooth">
		<center><br><br>
		<table border="1" width="650" style="font-family: cambria; font-weight: bold;">
			<tr style="background-color:black;color:white;">
				<td colspan="10" align="center">BOOTH DETAILS</td>
			</tr>
			...
			<%-- JAVA CODE FOR FUNCTION CALL TO RETRIVE RESULTSET OF BOOTH DETAILS --%>
			
			<%ResultSet rs=Methods.Boothdetails();%>
			<%while(rs.next())
			{%>
			<tr>
				...
				<a href="<%=request.getContextPath()%>/Files/JSP/officer/EditBooth.jsp?code=<%=rs.getInt(1)%>">Edit</a>
				</td>	
			</tr>	
			<%
			} %>
		</table><br><br>
		<a href="<%=request.getContextPath()%>/Files/JSP/officer/AddBooth.jsp">
