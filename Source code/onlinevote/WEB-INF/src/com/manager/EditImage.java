...
/* CLASS FOR EDIT IMAGE TO THE DATABASE */
...
public class EditImage extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
	  {		
        	  ...
        	  while ((x = sis.readLine(b, 0,dataLength)) > -1)
        	  {
        		  ...
        		  else if ((s.startsWith("Content-Disposition")) && (state == 0))
        		  {
		              ...
		              else
		              {
		                  ...
		                  {
		                	  String userAgent = request.getHeader("User-Agent");		                    	String userSeparator = "/";
			              ...
			              path = request.getRealPath("") +"/Files/images/voters/"+ fileName;
        ...
        response.sendRedirect(request.getContextPath()+"/Files/JSP/manager/EditVoterDetail.jsp?temp_photo="+fName);
	}					
}
