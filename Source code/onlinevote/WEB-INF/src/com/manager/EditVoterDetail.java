...
/* CLASS FOR EDIT VOTER DETAILS TO THE DATABASE */

public class EditVoterDetail extends HttpServlet
{

    ServletInputStream sis=null;
 
    /* METHOD FOR EDIT VOTER DETAILS TO THE DATABASE */	
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
	{
		...
		String temp_code=request.getParameter("v_code");
		...
		try 
		{
			...
			ses.setAttribute("temp_code",temp_code);
			...
			if(temp_photo==null)
			{
				/* FUNCTION CALL FOR EDIT VOTER DETAILS TO THE DATABASE*/
				response.sendRedirect(request.getContextPath()+"/Files/JSP/manager/EditImage.jsp");
			}
			else
			{
				Connection con;
				...
				int tcode=Integer.parseInt(temp_code);
				System.out.println("tcode="+tcode);
				boolean flag = Methods.updatevoter(tcode,temp_id_no,temp_name,temp_address,temp_sex,temp_age,booth_code,temp_photo,temp_position,temp_vote_status);	
				if(flag==true)
				{
					
					// EMPTY THE SESSION	
					
					ses.setAttribute("temp_code",null);
