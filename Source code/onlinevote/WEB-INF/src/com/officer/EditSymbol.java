...
/* CLASS FOR EDIT CANDIDATE SYMBOL */

public class EditSymbol extends HttpServlet
{

    ServletInputStream sis=null;
    
/* METHOD FOR EDIT CANDIDATE SYMBOL */    
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
     ...
     response.sendRedirect(request.getContextPath()+"/Files/JSP/officer/EditCandidate.jsp?tp_symbol="+fName);
	}
